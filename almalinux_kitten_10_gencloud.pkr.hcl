...
source "qemu" "almalinux_kitten_10_gencloud_s390x" {
  ...
  qemuargs = [
    ...
    ["-append", "ro ramdisk_size=40000 cio_ignore=all,!condev console=ttysclp0 ip=dhcp inst.text inst.ks=http://{{ .HTTPIP }}:{{ .HTTPPort }}/almalinux-kitten-10.gencloud-s390x.ks"],
